...
<div class="container" id="mainContainer">
    <div class="card" id="container">
        <div class="card-block">
            ...
            <p class="card-text"> <b>Path:</b> <br> ${item.path} </>
            <p class="card-text"> <b>Title:</b> <br> ${item.title} </>
            <p class="card-text"> <b>Url:</b> <br> <a href="${item.url}">${item.url}</a> </>
        </div>
    </div>
    <br>
    ...
    <form method="POST" action="../delete/itemLink" style="display:inline">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="POST" action="/move/itemLink">
                        <input type="hidden" name="path" value="${item.path}"/>
